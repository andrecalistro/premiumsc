    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9">
                <div class="categories-title"><?= $category->title ?><span
                            class="categories-total"><span>Resultado:</span> <?= $this->Paginator->total() ?> <?= $this->Paginator->total() > 1 ? 'itens' : 'item' ?> </span></div>
