...
$this->Html->script(['
    ...
    'store/category.functions.js'], ['fullBase' => true, 'block' => 'scriptBottom']);
    ...
    <div class="container">
        <div class="breadcrumb-content text-center">
            <ul>
                ...
                <li class="active">Busca por: <?= $param; ?> </li>
            </ul>
        </div>
    </div>
</div>
<div class="shop-area pt-95 pb-100">
    <div class="container">
        <div class="row flex-row-reverse">
            <div class="col-lg-12">
                <?= $this->element('Theme.box-filters-search') ?>
                    ...
                    <div class="row">
                        ...
                        <?php else: ?>
                            <div class="col-xl-12 col-md-12 col-lg-12 col-sm-12 text-center">
                                <p class="mt-4 mb-5">Nenhum produto encontrado</p>
                            </div>
                        <?php endif; ?>
                    </div>
