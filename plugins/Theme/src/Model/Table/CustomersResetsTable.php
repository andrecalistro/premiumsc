 ...
 *
 * @method \Theme\Model\Entity\CustomersReset get($primaryKey, $options = [])
 * @method \Theme\Model\Entity\CustomersReset newEntity($data = null, array $options = [])
 * @method \Theme\Model\Entity\CustomersReset[] newEntities(array $data, array $options = [])
 * @method \Theme\Model\Entity\CustomersReset|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Theme\Model\Entity\CustomersReset patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Theme\Model\Entity\CustomersReset[] patchEntities($entities, array $data, array $options = [])
 * @method \Theme\Model\Entity\CustomersReset findOrCreate($search, callable $callback = null, $options = [])
 *
...
class CustomersResetsTable extends AppTable
{
     ...
     * @param $customer
     * @param $store
     * @return \App\Model\Entity\CustomersReset|bool
     */
