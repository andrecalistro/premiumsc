 ...
 *
 * @method \Theme\Model\Entity\OrdersHistory get($primaryKey, $options = [])
 * @method \Theme\Model\Entity\OrdersHistory newEntity($data = null, array $options = [])
 * @method \Theme\Model\Entity\OrdersHistory[] newEntities(array $data, array $options = [])
 * @method \Theme\Model\Entity\OrdersHistory|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Theme\Model\Entity\OrdersHistory patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Theme\Model\Entity\OrdersHistory[] patchEntities($entities, array $data, array $options = [])
 * @method \Theme\Model\Entity\OrdersHistory findOrCreate($search, callable $callback = null, $options = [])
 *
...
class OrdersHistoriesTable extends AppTable
{
	...
	public function beforeSave($event, $entity, $options)
	{
		if ($entity->notify_customer) {
			$Orders = TableRegistry::get('Admin.Orders');
			$order = $Orders->get($entity->orders_id, ['contain' => ['Customers']]);

			$EmailTemplates = TableRegistry::get('Admin.EmailTemplates');
			$EmailQueues = TableRegistry::get('Admin.EmailQueues');
