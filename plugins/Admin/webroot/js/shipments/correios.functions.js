...
$(document).on('click', '#add-row-interval', function (e) {
    ...
    for (var i = 1; i <= quantity; i++) {
        row += "<td><input name='interval[" + row_number + "][]' type='text' class='form-control' required></td>"
    }
    row += "<td><a href=\"#\" class=\"btn btn-sm btn-danger remove-interval\" title='Excluir'><i class='fa fa-trash' aria-hidden='true'></i></a></td>";
    row += "</tr>";
