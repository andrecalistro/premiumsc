...
<div class="content mar-bottom-30">
	<div class="container-fluid pad-bottom-30">
		...
		<?= $this->Form->control('faq_categories_id', ['type' => 'hidden', 'label' => false]) ?>
		<div class="row">
			<div class="col-lg-3 col-sm-4 col-md-6 col-xs-12 form-group">
				<?= $this->Form->control('position', ['type' => 'number', 'class' => 'form-control', 'label' => 'Posição']) ?>
			</div>
		</div>
		<div class="row">
		...
		<?= $this->Html->link('Voltar', ['controller' => 'FaqQuestions', 'action' => 'category', $faqQuestion->faq_categories_id], ['class' => 'btn btn-primary btn-sm']) ?>
		<?= $this->Form->end() ?>
	</div>
</div>
