...
<div class="page-title">
    <h2>Mapear colunas para atualizar os produtos</h2>
</div>
<div class="content mar-bottom-30">
    <div class="container-fluid pad-bottom-30">
        ...
        <div class="row">
            <div class="col-md-6 col-xs-12"><?= $this->Html->link("<i class='fa fa-arrow-left'></i> Voltar", ['controller' => 'products', 'action' => 'update'], ['class' => 'btn btn-primary btn-sm', 'escape' => false]) ?></div>
