...
<div class="page-title">
    <h2>Configurar Cielo Cartao de Débito</h2>
</div>
<div class="content mar-bottom-30">
    <div class="container-fluid pad-bottom-30">
        <?= $this->Form->create($cielo_debit_card, ['type' => 'file']) ?>
            ...
            <div role="tabpanel" class="tab-pane fade in active" id="data">
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <?= $this->Form->control('label', ['label' => 'Nome para exibição', 'value' => $cielo_debit_card->label, 'class' => 'form-control']) ?>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= $this->Form->control('merchant_id', ['class' => 'form-control', 'label' => 'Cliente ID', 'value' => $cielo_debit_card->merchant_id, 'type' => 'text']) ?>
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div class="form-group">
                            <?= $this->Form->control('merchant_key', ['class' => 'form-control', 'label' => 'Cliente Key', 'value' => $cielo_debit_card->merchant_key]) ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?= $this->Form->control('environment', ['label' => false, 'empty' => 0, 'options' => $environments, 'type' => 'radio', 'value' => $cielo_debit_card->environment]) ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>Status</label>
                            <?= $this->Form->control('status', ['label' => false, 'empty' => 0, 'options' => $statuses, 'type' => 'radio', 'value' => $cielo_debit_card->status]) ?>
                        </div>
                    </div>
                </div>
                <hr>
