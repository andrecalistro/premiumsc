 ...
 */
class CieloCreditCardCell extends Cell
{
    ...
    {
        $this->viewBuilder()->setTemplatePath('Cell/Payment')->setTemplate('cielo_credit_card');
        ...
        $cardBrands = [
            'visa' => 'CheckoutV2.card-brands/visa.svg',
            'mastercard' => 'CheckoutV2.card-brands/mastercard.svg',
            'amex' => 'CheckoutV2.card-brands/amex.svg',
            'elo' => 'CheckoutV2.card-brands/elo.svg',
            'diners' => 'CheckoutV2.card-brands/diners.svg',
            'discover' => 'CheckoutV2.card-brands/discover.svg',
            'jcb' => 'CheckoutV2.card-brands/jcb.svg',
            'aura' => 'CheckoutV2.card-brands/aura.svg',
            'hipercard' => 'CheckoutV2.card-brands/hipercard.svg'
        ];

        $this->set(compact('public_key', 'document', 'name', 'birth_date', 'months', 'years', 'installments', 'cardBrands'));
    }
}
