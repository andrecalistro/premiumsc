...
/**
 * CieloDebitCardCell cell
 *
 * @var PaymentsTable $Payments
 */
class CieloDebitCardCell extends Cell
{
    ...
    {
        $this->viewBuilder()->setTemplatePath('Cell/Payment')->setTemplate('cielo_debit_card');
        ...
        $this->set(compact('public_key', 'document', 'name', 'birth_date', 'months', 'years', 'cardBrands'));
    }
}
