 ...
 *
 * @method \CheckoutV2\Model\Entity\OrdersHistory get($primaryKey, $options = [])
 * @method \CheckoutV2\Model\Entity\OrdersHistory newEntity($data = null, array $options = [])
 * @method \CheckoutV2\Model\Entity\OrdersHistory[] newEntities(array $data, array $options = [])
 * @method \CheckoutV2\Model\Entity\OrdersHistory|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \CheckoutV2\Model\Entity\OrdersHistory patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \CheckoutV2\Model\Entity\OrdersHistory[] patchEntities($entities, array $data, array $options = [])
 * @method \CheckoutV2\Model\Entity\OrdersHistory findOrCreate($search, callable $callback = null, $options = [])
 *
