 ...
 *
 * @method \CheckoutV2\Model\Entity\CustomersConfirmation get($primaryKey, $options = [])
 * @method \CheckoutV2\Model\Entity\CustomersConfirmation newEntity($data = null, array $options = [])
 * @method \CheckoutV2\Model\Entity\CustomersConfirmation[] newEntities(array $data, array $options = [])
 * @method \CheckoutV2\Model\Entity\CustomersConfirmation|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \CheckoutV2\Model\Entity\CustomersConfirmation patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \CheckoutV2\Model\Entity\CustomersConfirmation[] patchEntities($entities, array $data, array $options = [])
 * @method \CheckoutV2\Model\Entity\CustomersConfirmation findOrCreate($search, callable $callback = null, $options = [])
 *
