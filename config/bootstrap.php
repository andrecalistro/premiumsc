...
Plugin::loadAll([
    'Migrations',
    'Josegonzalez/Upload',
    'Admin' => ['bootstrap' => false, 'routes' => true],
    'SoftDelete',
    'Recaptcha',
    Configure::read('Theme') => ['routes' => true, 'autoload' => true],
    'CakePdf' => ['bootstrap' => true]
]);

Plugin::load(['CheckoutV2' => ['routes' => true, 'autoload' => true]]);
Plugin::load(['Subscriptions' => ['routes' => true, 'autoload' => true]]);
